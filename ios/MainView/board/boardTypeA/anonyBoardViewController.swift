//
//  anonyBoardViewController.swift
//  ios
//
...
class anonyBoardViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var anonyFeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "anonyCell", for: indexPath) as! anonyTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "anonyTableViewCell", bundle: nil)
        anonyFeedTableView.register(nibName, forCellReuseIdentifier: "anonyCell")
        anonyFeedTableView.rowHeight = 335
        anonyFeedTableView.dataSource = self
        anonyFeedTableView.delegate = self
