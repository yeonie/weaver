...
class freeBoardViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var freeFeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "freeCell", for: indexPath) as! freeTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "freeTableViewCell", bundle: nil)
        freeFeedTableView.register(nibName, forCellReuseIdentifier: "freeCell")
        freeFeedTableView.rowHeight = 335
        freeFeedTableView.dataSource = self
        freeFeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 250/255, green: 226/255, blue: 103/255, alpha: 1.0)
