//
//  threeTeenBoardViewController.swift
//  ios
//
...
class threeTeenBoardViewController: BaseViewController , UITableViewDataSource, UITableViewDelegate{
    ...
    @IBOutlet weak var threeTeenTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "threeTeenCell", for: indexPath) as! threeTeenTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "threeTeenTableViewCell", bundle: nil)
        threeTeenTableView.register(nibName, forCellReuseIdentifier: "threeTeenCell")
        threeTeenTableView.rowHeight = 335
        threeTeenTableView.dataSource = self
        threeTeenTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "30대 게시판"
