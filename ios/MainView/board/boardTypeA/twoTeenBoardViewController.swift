//
//  twoTeenBoardViewController.swift
//  ios
//
...
class twoTeenBoardViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var twoTeenTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "twoTeenCell", for: indexPath) as! twoTeenTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "twoTeenTableViewCell", bundle: nil)
        twoTeenTableView.register(nibName, forCellReuseIdentifier: "twoTeenCell")
        twoTeenTableView.rowHeight = 335
        twoTeenTableView.dataSource = self
        twoTeenTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "20대 게시판"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 236/255, green: 238/255, blue: 238/255, alpha: 1.0)
