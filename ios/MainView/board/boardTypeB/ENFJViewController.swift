...
class ENFJViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var ENFJfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ENFJcell", for: indexPath) as! ENFJTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "ENFJTableViewCell", bundle: nil)
        ENFJfeedTableView.register(nibName, forCellReuseIdentifier: "ENFJcell")
        ENFJfeedTableView.rowHeight = 335
        ENFJfeedTableView.dataSource = self
        ENFJfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "ENFJ"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 193/255, green: 159/255, blue: 151/255, alpha: 1.0)
