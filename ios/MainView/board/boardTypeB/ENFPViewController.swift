...
class ENFPViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var ENFPfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ENFPcell", for: indexPath) as! ENFPTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "ENFPTableViewCell", bundle: nil)
        ENFPfeedTableView.register(nibName, forCellReuseIdentifier: "ENFPcell")
        ENFPfeedTableView.rowHeight = 335
        ENFPfeedTableView.dataSource = self
        ENFPfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "ENFP"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 253/255, green: 186/255, blue: 181/255, alpha: 1.0)
//        +8/-2/-2
