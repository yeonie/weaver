...
class ENTJViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var ENTJfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ENTJcell", for: indexPath) as! ENTJTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "ENTJTableViewCell", bundle: nil)
        ENTJfeedTableView.register(nibName, forCellReuseIdentifier: "ENTJcell")
        ENTJfeedTableView.rowHeight = 335
        ENTJfeedTableView.dataSource = self
        ENTJfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "ENTJ"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 132/255, green: 222/255, blue: 242/255, alpha: 1.0)
