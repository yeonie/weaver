...
class ENTPViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var ENTPfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ENTPcell", for: indexPath) as! ENTPTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "ENTPTableViewCell", bundle: nil)
        ENTPfeedTableView.register(nibName, forCellReuseIdentifier: "ENTPcell")
        ENTPfeedTableView.rowHeight = 335
        ENTPfeedTableView.dataSource = self
        ENTPfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "ENTP"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 156/255, green: 209/255, blue: 200/255, alpha: 1.0)
