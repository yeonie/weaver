...
class ESTJViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var ESTJfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ESTJcell", for: indexPath) as! ESTJTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "ESTJTableViewCell", bundle: nil)
        ESTJfeedTableView.register(nibName, forCellReuseIdentifier: "ESTJcell")
        ESTJfeedTableView.rowHeight = 335
        ESTJfeedTableView.dataSource = self
        ESTJfeedTableView.delegate = self
