...
class ESTPViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var ESTPfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ESTPcell", for: indexPath) as! ESTPTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "ESTPTableViewCell", bundle: nil)
        ESTPfeedTableView.register(nibName, forCellReuseIdentifier: "ESTPcell")
        ESTPfeedTableView.rowHeight = 335
        ESTPfeedTableView.dataSource = self
        ESTPfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "ESTP"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 239/255, green: 82/255, blue: 80/255, alpha: 1.0)
