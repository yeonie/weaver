...
class INFJViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var INFJfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "INFJcell", for: indexPath) as! INFJTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "INFJTableViewCell", bundle: nil)
        INFJfeedTableView.register(nibName, forCellReuseIdentifier: "INFJcell")
        INFJfeedTableView.rowHeight = 335
        INFJfeedTableView.dataSource = self
        INFJfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "INFJ"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 209/255, green: 79/255, blue: 140/255, alpha: 1.0)
