...
class INFPViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var INFPfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "INFPcell", for: indexPath) as! INFPTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "INFPTableViewCell", bundle: nil)
        INFPfeedTableView.register(nibName, forCellReuseIdentifier: "INFPcell")
        INFPfeedTableView.rowHeight = 335
        INFPfeedTableView.dataSource = self
        INFPfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "INFP"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 43/255, green: 113/255, blue: 116/255, alpha: 1.0)
