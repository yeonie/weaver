...
class INTJViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var INTJfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "INTJcell", for: indexPath) as! INTJTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "INTJTableViewCell", bundle: nil)
        INTJfeedTableView.register(nibName, forCellReuseIdentifier: "INTJcell")
        INTJfeedTableView.rowHeight = 335
        INTJfeedTableView.dataSource = self
        INTJfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "INTJ"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 81/255, green: 126/255, blue: 254/255, alpha: 1.0)
