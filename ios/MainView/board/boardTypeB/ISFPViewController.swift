...
class ISFPViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var ISFPfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ISFPcell", for: indexPath) as! ISFPTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "ISFPTableViewCell", bundle: nil)
        ISFPfeedTableView.register(nibName, forCellReuseIdentifier: "ISFPcell")
        ISFPfeedTableView.rowHeight = 335
        ISFPfeedTableView.dataSource = self
        ISFPfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "ISFP"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 192/255, green: 182/255, blue: 255/255, alpha: 1.0)
