...
class ISTJViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var ISTJfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ISTJcell", for: indexPath) as! ISTJTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "ISTJTableViewCell", bundle: nil)
        ISTJfeedTableView.register(nibName, forCellReuseIdentifier: "ISTJcell")
        ISTJfeedTableView.rowHeight = 335
        ISTJfeedTableView.dataSource = self
        ISTJfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "ISTJ"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 66/255, green: 149/255, blue: 107/255, alpha: 1.0)
