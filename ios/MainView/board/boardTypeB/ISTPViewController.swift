...
class ISTPViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var ISTPfeedTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ISTPcell", for: indexPath) as! ISTPTableViewCell
    ...
    override func viewDidLoad() {
        ...
        let nibName = UINib(nibName: "ISTPTableViewCell", bundle: nil)
        ISTPfeedTableView.register(nibName, forCellReuseIdentifier: "ISTPcell")
        ISTPfeedTableView.rowHeight = 335
        ISTPfeedTableView.dataSource = self
        ISTPfeedTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "ISTP"
        //        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "whiteBackground"), for: .default)
        self.navigationController?.navigationBar.backgroundColor = UIColor.init(red: 162/255, green: 82/255, blue: 205/255, alpha: 1.0)
